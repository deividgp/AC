...
#Art
sim-bpred -redir:sim nottakenArt -fastfwd 50000000 -max:inst 65000000 -bpred nottaken ../art/exe/art.exe -scanfile c756hel.in -trainfile1 ../art/data/ref/a10.img -stride 2 -startx 134 -starty 220 -endx 139 -endy 225 -objects 1 > ./art.out 2> ./art.err