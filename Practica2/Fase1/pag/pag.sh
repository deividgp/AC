#Ammp
sim-outorder -redir:sim pagAmmp -fastfwd 50000000 -max:inst 65000000 -bpred:2lev 4 4 3 0 -mem:width 32 -mem:lat 300 2 ../ammp/exe/ammp.exe ammp < ../ammp/data/ref/ammp.in > ./ammp.out 2> ./ammp.err
#Gap
sim-outorder -redir:sim pagGap -fastfwd 50000000 -max:inst 65000000 -bpred:2lev 4 4 3 0 -mem:width 32 -mem:lat 300 2 ../gap/exe/gap.exe -l ./ -q -m 192M < ../gap/data/ref/ref.in > ./gap.out 2> ./gap.err
#Bzip2
sim-outorder -redir:sim pagBzip2 -fastfwd 50000000 -max:inst 65000000 -bpred:2lev 4 4 3 0 -mem:width 32 -mem:lat 300 2 ../bzip2/exe/bzip2.exe ../bzip2/data/ref/input.source 58 > ./bzip2.out 2> ./bzip2.err
#Vpr
