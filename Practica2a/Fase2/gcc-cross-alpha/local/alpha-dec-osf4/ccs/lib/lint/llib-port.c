 ...
 * HISTORY
 */
#pragma ident "@(#)$RCSfile: llib-port.c,v $ $Revision: 4.2.10.2 $ (DEC) $Date: 1995/01/26 03:48:16 $"
...
#include <nl_types.h>
nl_catd catopen (c,x) char *c; int x; { return ((nl_catd)0); }
char *catgets (catd, x, y, c) nl_catd catd; int x; int y; char *c;
{ return (c); }
