...
# HISTORY
# 
# @(#)$RCSfile: newvers.sh,v $ $Revision: 4.4.25.2 $ (DEC) $Date: 1995/03/28 20:38:07 $ 
#
...
(
  ...
  echo "#ifdef KERNEL_UNI" ;
  echo "CONST char version[] = \"Digital UNIX [UNI] ${v}${variant} (Rev. ${rev}); ${t} ${nl}\";" ;
  echo "#else" ;
  echo "CONST char version[] = \"Digital UNIX ${v}${variant} (Rev. ${rev}); ${t} ${nl}\";" ;
  echo "#endif" ;
