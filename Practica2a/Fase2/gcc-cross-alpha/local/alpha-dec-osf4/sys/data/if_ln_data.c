 ...
 */
/*	
 *	@(#)$RCSfile: if_ln_data.c,v $ $Revision: 1.2.32.2 $ (DEC) $Date: 1995/10/20 19:46:33 $
 */ 
/*
...
{ 	0x1C0C0000,   0x1C0C0004,     0x1C080000,     0x00000000,
	...
	ln_bzero4x4,	ln_setflag16,	lninitdesc}
};
...
#if defined VAX420 || defined MVAX || defined DS5000_100 || defined DS5000_300
...
#elif defined DS5000_100 || defined DS5000_300
