...
#pragma ident "@(#)$RCSfile: if_te_data.c,v $ $Revision: 1.1.18.2 $ (DEC) $Date: 1996/01/12 17:46:53 $"
...
#define ztime   is_ed.ess_ztime         /* Time counters last zeroed    */
	...
	simple_lock_data_t lk_te_softc;	/* SMP lock for te_softc	*/
	struct tedebug { 
...
extern	struct	controller *teinfo[];
#else
