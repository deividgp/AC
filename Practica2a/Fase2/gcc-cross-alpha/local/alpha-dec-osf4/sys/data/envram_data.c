 ...
 */
/*
 * @(#)$RCSfile: envram_data.c,v $ $Revision: 1.1.20.2 $ (DEC) $Date: 1998/08/07 12:39:38 $
 */
 ...
 */
struct	envram_softc {
    simple_lock_data_t env_lock;     /* softc lock                 */
    io_handle_t	regbase;	     /* base address for registers */

    /*
     * DMA control
     */
    volatile u_int dma_in_progress;  /* 1: DMA in progress, 0: No DMA in progress */
...
extern struct 	envram_softc *envram_softc;
extern struct	controller *envram_info[];
