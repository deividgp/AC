 ...
 */
/*	
 *	@(#)$RCSfile: param.h,v $ $Revision: 4.3.26.4 $ (DEC) $Date: 1997/08/28 18:59:37 $
 */ 
/*
 */
/*
...
#define PSUSP   01000   /* implies can be asynchronously suspended while waiting */
...
#define MS_LOCK_NO_RELOCK	0x0008		/* don't reacquire lock  */
