 ...
 */
/*	
 *	@(#)$RCSfile: systm.h,v $ $Revision: 4.3.18.2 $ (DEC) $Date: 1994/12/15 22:05:03 $
 */ 
/*
...
struct compat_mod {
	...
	struct compat_mod *(*cm_recognizer) __((struct filehdr *, ...)); /* called by exec	*/
	struct sysent   *(*cm_syscall) __((int, ...));	/* returns needed sysent */
 ...
 */
_BEGIN_CPLUSPLUS
extern int cm_setup __((struct compat_mod *, char *, int, char *, char *, int,
   int(*) (int, ...), struct compat_mod *(*) (struct filehdr *, ...),
   struct sysent *(*) (int, ...), char **, int *, char *, int, int, int));
extern int cm_trace_this __((struct compat_mod *));
extern int cm_add __((struct compat_mod *));
extern int cm_del __((struct compat_mod *));
...
extern int cm_query __((struct compat_mod *, int *, size_t, int *, size_t));
extern int cm_operate __((struct compat_mod *, int *, size_t, int *, size_t));
_END_CPLUSPLUS
