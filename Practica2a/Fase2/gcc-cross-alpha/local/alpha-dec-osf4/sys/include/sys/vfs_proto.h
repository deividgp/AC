 ...
 */
/*
 *	@(#)$RCSfile: vfs_proto.h,v $ $Revision: 1.1.41.2 $ (DEC) $Date: 1998/09/28 17:07:54 $
 */ 
...
#include <sys/vnode.h>   /* to pick up vtagtype enum */
#else
...
extern void update_sleeper_blkpids(struct vnode *  , struct eflock *  , int );
...
extern int vfs_name_hash(char *, char *, struct vnode *, u_long *);
