 ...
 */
/*
 * @(#)$RCSfile: svc.h,v $ $Revision: 1.1.11.2 $ (DEC) $Date: 1995/04/24 21:06:26 $
 */
...
struct svcxprt{
	...
	struct xp_ops {
	    bool_t	(*xp_recv)();	 /* get message from socket */
	    bool_t	(*xp_input)();	 /* received message in an mbuf */
...
#define SVC_INPUT(xprt, msg, m, sin)			\
	(*(xprt)->xp_ops->xp_input)((xprt), (msg), (m), (sin))
#define svc_input(xprt, msg, m, sin)			\
	(*(xprt)->xp_ops->xp_input)((xprt), (msg), (m), (sin))
