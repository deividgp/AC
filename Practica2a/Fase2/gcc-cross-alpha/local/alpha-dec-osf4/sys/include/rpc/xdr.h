 ...
 */
/*
 * @(#)$RCSfile: xdr.h,v $ $Revision: 1.1.15.2 $ (DEC) $Date: 1998/09/25 14:48:08 $
 */
...
extern bool_t       xdrmbuf_putbuf(XDR *, caddr_t, u_int, void (*)(), caddr_t);
extern bool_t       xdrmbuf_putopaque(XDR *, caddr_t, u_int,
				      void (*)(), caddr_t);
extern struct mbuf *xdrrecmbuf_recv(XDR *, struct socket *, u_int, u_int *);
extern bool_t       xdrrecmbuf_avail(struct socket *, u_int *, u_int *);
extern int          xdrrecmbuf_send(XDR *, struct socket *, struct mbuf *);
#endif /* !KERNEL */
