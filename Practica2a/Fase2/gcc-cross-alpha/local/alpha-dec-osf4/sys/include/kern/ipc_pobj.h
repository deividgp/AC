 ...
 */
/*	
 *	@(#)$RCSfile: ipc_pobj.h,v $ $Revision: 4.2.11.2 $ (DEC) $Date: 1997/01/16 20:11:25 $
 */ 
/*
 */
/*
...
extern host_priv_t convert_port_to_host_priv();
...
extern port_name_t convert_port_to_uport();
extern port_name_t convert_thread_to_uport();
extern thread_t convert_uport_to_thread();
