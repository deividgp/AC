...
struct rpb_percpu {
    ...
    long   rpb_cachesize;       /* 268: System cache size (primary cpu) */
    long   rpb_pcrsvd[2];	/* 270: reserved for arch use */
 ...
 *
 *      o bits<55:0> are System Cache Size
 *      o bits<63:56> are System Cache Type
 *
 *            - 1 = Two-Way Associative, Write Back
 *
 *              **** ADD NEW TYPE CODES HERE AS REQUIRED ****
 */
#define RPB_CACHESIZE           0x00ffffffffffffffL
#define RPB_CACHETYPE           0xff00000000000000L

#define RPB_CACHETYPE_SHIFT     56

#define RPB_CACHETYPE_2WAWB     1
...
#define PMEM_CLUSTER_NTYPE 	((long)3)
