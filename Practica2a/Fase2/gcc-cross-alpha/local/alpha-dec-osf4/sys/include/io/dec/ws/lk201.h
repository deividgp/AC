 ...
 */
/*
 * @(#)$RCSfile: lk201.h,v $ $Revision: 1.1.10.2 $ (DEC) $Date: 1998/06/26 19:21:32 $
 */
/*
...
#ifdef KERNEL
int lk201_getc(unsigned int);
int lk201_putc(char);
caddr_t lk201_init_closure(caddr_t);
void lk201_up_down_mode(ws_keyboard_state *);
void lk201_reset_keyboard(ws_keyboard_state *);
void lk201_ring_bell(caddr_t);
int lk201_set_keyboard_control(caddr_t, ws_keyboard *, ws_keyboard_control *);
void lk201_autorepeat(caddr_t);
void lk201_keyboard_event(caddr_t, ws_event_queue *, int, ws_pointer *);
void lk201_keyboard_char(ws_keyboard_state *, u_short);
void lk201_set_leds(ws_keyboard_state *);
#endif
