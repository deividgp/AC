 ...
 */
/*
 * @(#)$RCSfile: scsi_all.h,v $ $Revision: 1.1.31.2 $ (DEC) $Date: 1998/08/26 20:58:24 $
 */
#ifndef _SCSI_ALL_
#define _SCSI_ALL_
...
#define ALL_PROUT_WRITE_EXC_RO  0x5     /* share read, registrants only write */
#define ALL_PROUT_BOTH_EXC_RO   0x6     /* registrants only, read & write  */
