 ...
 */
/*
#pragma ident "@(#)$RCSfile: if_pdqreg.h,v $ $Revision: 1.1.35.2 $ (DEC) $Date: 1998/05/08 17:56:49 $"
 */
...
#define TRT_MAX  173	/* Maximum TRT for the ring = 167.77224 ms */
...
#define PI_RSP_K_TIMEOUT		    0x27
#define PI_RSP_K_MAX		    	    0x28
...
#define PI_UNSOL_LINK_ARG_K_MAX		    4
...
#else		/* for faa until if_fxx is cleaned-up - rajul */
