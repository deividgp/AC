 ...
 */
/*
 * @(#)$RCSfile: scripthost.h,v $ $Revision: 1.1.16.3 $ (DEC) $Date: 1995/08/22 20:24:19 $
 */
...
/* WARNING!!!
 * In the case of SJ_OFFSET_MSGOPTR, the actual value of 0x18 is hardcoded
 * into several instructions that look for carry when adding
 * SJ_OFFSET_MSGOPTR. If the value is changed, the scripts code must also
 * change.
 */
