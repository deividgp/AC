 ...
 */
/*	
 *	@(#)$RCSfile: if_lnreg.h,v $ $Revision: 1.2.17.2 $ (DEC) $Date: 1994/01/23 21:14:57 $
 */ 
/*
 */
/*
 ...
 * These are now offset from the first register.
 */
#define NICSR_OFFSET	0x0
#define RDP_OFFSET	0x4
#define RAP_OFFSET	0x6
#define NI_ROM_OFFSET	0xC
