 ...
 *	    PAGE_VAL
 *		This flag is used in conjuction with the struct member
 *		scsi_page_size. The flag tells the driver if that field
 *		is valid and available for use. The scsi_page_size member is
 *		used in only SCSI 2 type devices. The scsi_page_size member is
 ...
 *		should be set and the scsi_page_size member should be 16, which
...
#define PAGE_VAL		0x00000040	/* scsi_page_size is valid */
...
struct tape_opt_tab {
	...
	char scsi_page_size;	/* SCSI 2 page size			*/
