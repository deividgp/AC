 ...
 */
/*
#pragma ident "@(#)$RCSfile: if_fzareg.h,v $ $Revision: 1.2.11.2 $ (DEC) $Date: 1995/05/03 21:21:01 $"
 */
...
#define lo ctru.i32.low
#define hi ctru.i32.high
#define longctr ctru.ctr
#define shortctr ctru.i16.lw
