...
#define SKZ_TMS_ERROR   2          /* Target Mode Status Error */
#define SKZ_AME_ERROR	3
#define SKZ_DSE_ERROR	4
#define SKZ_QB_ERROR	5
#define SKZ_ERROR	6
#define SKZ_TGT_ERROR   7
...
#define SKZ_RESET_BUS	        0x00000004L	/* Error calls for bus reset */
#define SKZ_RESTART_ADAPTER	0x00000008L 	/* Set for adapter reset */
...
#define SKZ_RESET_ADAPTER	0x00000200L
#define SKZ_REGISTER_DATA	0x00000400L
#define SKZ_BTL_VALID		0x00000800L
#define SKZ_CHAN_VALID		0x00001000L
#define SKZ_BUS_RESET_RECVD     0x00002000L   /* Third party bus reset done */
#define SKZ_BUS_RESET_REQ       0x00004000L   /* Bus reset requested during
						 Adapter Reset */
...
/* 
** Target Mode Interrupt completion code - used in the SKZ_ERR_BUFF 
** error_code field to indicate the skz_process_error should complete a
** Target mode interrupt with the information contained in the error buffer
*/

#define XZA_TARGET_INTERRUPT            0x666   /* The number of Man */

#define XZA_ILL_ASR_STATUS              0x0
...
#define XZA_ADAPTER_RESET_REQ           0x6   /* Psuedo ACC error */
#define XZA_BUS_RESET_COMPLETE          0x7   /* Psuedo ACC error */
#define XZA_ADAPTER_RESTART_REQ         0x8   /* Psuedo ACC code */

/* Adapter Target Mode Status Codes, ASR TMSC values */

#define XZA_TMSC_NONE                   0x0
#define XZA_TMSC_LUN_ENABLED            0x21
#define XZA_TMSC_LUN_DISABLED           0x22
#define XZA_TMSC_LUN_DEFAULTED          0x23
#define XZA_TMSC_INVALID_SEL            0x24
#define XZA_TMSC_INVLD_IDENT            0x25
#define XZA_TMSC_UNSPRTD_CDB_RCVD       0x26
#define XZA_TMSC_SCSI_CDB_RCVD          0x27
#define XZA_TMSC_SCSI_CMD_CMPLT         0x28
#define XZA_TMSC_BUS_SENSE_BFREE        0x29
#define XZA_TMSC_SCSI_BDR_RCVD          0x2A
#define XZA_TMSC_CMD_ABRTD              0x2B
#define XZA_TMSC_INVLD_RESEL            0x2C
#define XZA_TMSC_BUS_SENSE_BDISC        0x2D
#define XZA_TMSC_BUS_SENSE_BHELD        0x2E
#define XZA_TMSC_BUS_RELEASE            0x2F
#define XZA_TMSC_RESEL_TO               0x30
