...
typedef struct eeprom_fcn {
	...
	unsigned int	c0drst	: 1;	/* Chan 0 disable reset */
	unsigned int	c1drst	: 1;	/* Chan 1 disable reset */
	unsigned int	c0fast	: 1;	/* Chan 0 enable fast */
	unsigned int	c1fast	: 1;	/* Chan 0 enable fast */
	unsigned int	uc0id	: 1;	/* Update Chan 0 id in EEPROM */
	unsigned int	uc1id	: 1;	/* Update Chan 1 id in EEPROM */
	unsigned int	c0_id	: 8;	/* Chan 0 scsi id */
	unsigned int	c1_id	: 8;	/* Chan 0 scsi id */
} EEPROM_FCN;
