 ...
 */
/*
 * @(#)$RCSfile: sim.h,v $ $Revision: 1.1.78.2 $ (DEC) $Date: 1998/07/23 13:23:21 $
 */
#ifndef _SIM_
#define _SIM_
 ...
 */
#define SIM_INSERT(que_elem, queue) insque((void *)(que_elem), (void *)(queue))

#define SIM_REMOVE(que_elem) remque((void *)(que_elem))

#define SIM_INSERT_TAIL(que_elem, queue) enqueue_tail((void *)(queue), (void *)(que_elem))

#define SIM_REMOVE_HEAD(queue) dequeue_head((void *)(queue))
