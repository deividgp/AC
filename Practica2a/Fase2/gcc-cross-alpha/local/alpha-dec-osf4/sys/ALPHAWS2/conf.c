...
/*
 * This is the static subsystem configuration table.
 * It is automatically generated by config in order
 * to record needed information about loadable subsystems
 * that are being statically linked into the kernel.
 */
extern int cm_configure();
extern cfg_subsys_attr_t cm_attributes[];
extern int generic_configure();
extern cfg_subsys_attr_t generic_attributes[];
extern int io_configure();
extern cfg_subsys_attr_t io_attributes[];
extern int ipc_configure();
extern cfg_subsys_attr_t ipc_attributes[];
extern int proc_configure();
extern cfg_subsys_attr_t proc_attributes[];
extern int sec_configure();
extern cfg_subsys_attr_t sec_attributes[];
extern int socket_configure();
extern cfg_subsys_attr_t socket_attributes[];
extern int rt_configure();
extern cfg_subsys_attr_t rt_attributes[];
extern int bsd_tty_configure();
extern cfg_subsys_attr_t bsd_tty_attributes[];
extern int xpr_configure();
extern cfg_subsys_attr_t xpr_attributes[];
extern int kdebug_configure();
extern cfg_subsys_attr_t kdebug_attributes[];
extern int dli_configure();
extern cfg_subsys_attr_t dli_attributes[];
extern int ffm_fs_configure();
extern cfg_subsys_attr_t ffm_fs_attributes[];
extern int atm_configure();
extern cfg_subsys_attr_t atm_attributes[];
extern int atmip_configure();
extern cfg_subsys_attr_t atmip_attributes[];
extern int lane_configure();
extern cfg_subsys_attr_t lane_attributes[];
extern int atmifmp_configure();
extern cfg_subsys_attr_t atmifmp_attributes[];
extern int atmuni_configure();
extern cfg_subsys_attr_t atmuni_attributes[];
extern int atmilmi3x_configure();
extern cfg_subsys_attr_t atmilmi3x_attributes[];
extern int uni3x_configure();
extern cfg_subsys_attr_t uni3x_attributes[];
extern int bparm_configure();
extern cfg_subsys_attr_t bparm_attributes[];
extern int advfs_configure();
extern cfg_subsys_attr_t advfs_attributes[];
extern int net_configure();
extern cfg_subsys_attr_t net_attributes[];
extern int netrain_configure();
extern cfg_subsys_attr_t netrain_attributes[];
extern int ppp_configure();
extern cfg_subsys_attr_t ppp_attributes[];
extern int inet_configure();
extern cfg_subsys_attr_t inet_attributes[];
extern int snmpinfo_configure();
extern cfg_subsys_attr_t snmpinfo_attributes[];
extern int bufcall_configure();
extern cfg_subsys_attr_t bufcall_attributes[];
extern int streams_configure();
extern cfg_subsys_attr_t streams_attributes[];
extern int dlb_configure();
extern cfg_subsys_attr_t dlb_attributes[];
extern int kinfo_configure();
extern cfg_subsys_attr_t kinfo_attributes[];
extern int strstd_configure();
extern cfg_subsys_attr_t strstd_attributes[];
extern int timod_configure();
extern cfg_subsys_attr_t timod_attributes[];
extern int tirdwr_configure();
extern cfg_subsys_attr_t tirdwr_attributes[];
extern int ldtty_configure();
extern cfg_subsys_attr_t ldtty_attributes[];
extern int xtiso_configure();
extern cfg_subsys_attr_t xtiso_attributes[];
extern int pts_configure();
extern cfg_subsys_attr_t pts_attributes[];
extern int ufs_configure();
extern cfg_subsys_attr_t ufs_attributes[];
extern int vfs_configure();
extern cfg_subsys_attr_t vfs_attributes[];
extern int vm_configure();
extern cfg_subsys_attr_t vm_attributes[];
extern int pwrmgr_configure();
extern cfg_subsys_attr_t pwrmgr_attributes[];
extern int kn600_configure();
extern cfg_subsys_attr_t kn600_attributes[];
extern int dc104x_configure();
extern cfg_subsys_attr_t dc104x_attributes[];
extern int cma_dd_configure();
extern cfg_subsys_attr_t cma_dd_attributes[];
extern int cam_disk_configure();
extern cfg_subsys_attr_t cam_disk_attributes[];
extern int cam_tape_configure();
extern cfg_subsys_attr_t cam_tape_attributes[];
extern int cam_configure();
extern cfg_subsys_attr_t cam_attributes[];
extern int isp_configure();
extern cfg_subsys_attr_t isp_attributes[];
extern int isa_configure();
extern cfg_subsys_attr_t isa_attributes[];
extern int ace_configure();
extern cfg_subsys_attr_t ace_attributes[];
extern int pci_configure();
extern cfg_subsys_attr_t pci_attributes[];
extern int ws_configure();
extern cfg_subsys_attr_t ws_attributes[];
extern int gpc_input_configure();
extern cfg_subsys_attr_t gpc_input_attributes[];
extern int vga_configure();
extern cfg_subsys_attr_t vga_attributes[];
extern int lsm_configure();
extern cfg_subsys_attr_t lsm_attributes[];
extern int ddr_configure();
extern cfg_subsys_attr_t ddr_attributes[];
extern int kio_configure();
extern cfg_subsys_attr_t kio_attributes[];
extern int kds_configure();
extern cfg_subsys_attr_t kds_attributes[];
extern int lan_common_configure();
extern cfg_subsys_attr_t lan_common_attributes[];
extern int per_configure();
extern cfg_subsys_attr_t per_attributes[];

subsys_info_t static_subsys_list[] =
{
{	0L, cm_configure,
	CFG_STATE_LOADED, "cm",
	cm_attributes, 0, NULL},
{	0L, generic_configure,
	CFG_STATE_LOADED, "generic",
	generic_attributes, 0, NULL},
{	0L, io_configure,
	CFG_STATE_LOADED, "io",
	io_attributes, 0, NULL},
{	0L, ipc_configure,
	CFG_STATE_LOADED, "ipc",
	ipc_attributes, 0, NULL},
{	0L, proc_configure,
	CFG_STATE_LOADED, "proc",
	proc_attributes, 0, NULL},
{	0L, sec_configure,
	CFG_STATE_LOADED, "sec",
	sec_attributes, 0, NULL},
{	0L, socket_configure,
	CFG_STATE_LOADED, "socket",
	socket_attributes, 0, NULL},
{	0L, rt_configure,
	CFG_STATE_LOADED, "rt",
	rt_attributes, 0, NULL},
{	0L, bsd_tty_configure,
	CFG_STATE_LOADED, "bsd_tty",
	bsd_tty_attributes, 0, NULL},
{	0L, xpr_configure,
	CFG_STATE_LOADED, "xpr",
	xpr_attributes, 0, NULL},
{	0L, kdebug_configure,
	CFG_STATE_LOADED, "kdebug",
	kdebug_attributes, 0, NULL},
{	0L, dli_configure,
	CFG_STATE_LOADED, "dli",
	dli_attributes, 0, NULL},
{	0L, ffm_fs_configure,
	CFG_STATE_LOADED, "ffm_fs",
	ffm_fs_attributes, 0, NULL},
{	0L, atm_configure,
	CFG_STATE_LOADED, "atm",
	atm_attributes, 0, NULL},
{	0L, atmip_configure,
	CFG_STATE_LOADED, "atmip",
	atmip_attributes, 0, NULL},
{	0L, lane_configure,
	CFG_STATE_LOADED, "lane",
	lane_attributes, 0, NULL},
{	0L, atmifmp_configure,
	CFG_STATE_LOADED, "atmifmp",
	atmifmp_attributes, 0, NULL},
{	0L, atmuni_configure,
	CFG_STATE_LOADED, "atmuni",
	atmuni_attributes, 0, NULL},
{	0L, atmilmi3x_configure,
	CFG_STATE_LOADED, "atmilmi3x",
	atmilmi3x_attributes, 0, NULL},
{	0L, uni3x_configure,
	CFG_STATE_LOADED, "uni3x",
	uni3x_attributes, 0, NULL},
{	0L, bparm_configure,
	CFG_STATE_LOADED, "bparm",
	bparm_attributes, 0, NULL},
{	0L, advfs_configure,
	CFG_STATE_LOADED, "advfs",
	advfs_attributes, 0, NULL},
{	0L, net_configure,
	CFG_STATE_LOADED, "net",
	net_attributes, 0, NULL},
{	0L, netrain_configure,
	CFG_STATE_LOADED, "netrain",
	netrain_attributes, 0, NULL},
{	0L, ppp_configure,
	CFG_STATE_LOADED, "ppp",
	ppp_attributes, 0, NULL},
{	0L, inet_configure,
	CFG_STATE_LOADED, "inet",
	inet_attributes, 0, NULL},
{	0L, snmpinfo_configure,
	CFG_STATE_LOADED, "snmpinfo",
	snmpinfo_attributes, 0, NULL},
{	0L, bufcall_configure,
	CFG_STATE_LOADED, "bufcall",
	bufcall_attributes, 0, NULL},
{	0L, streams_configure,
	CFG_STATE_LOADED, "streams",
	streams_attributes, 0, NULL},
{	0L, dlb_configure,
	CFG_STATE_LOADED, "dlb",
	dlb_attributes, 0, NULL},
{	0L, kinfo_configure,
	CFG_STATE_LOADED, "kinfo",
	kinfo_attributes, 0, NULL},
{	0L, strstd_configure,
	CFG_STATE_LOADED, "strstd",
	strstd_attributes, 0, NULL},
{	0L, timod_configure,
	CFG_STATE_LOADED, "timod",
	timod_attributes, 0, NULL},
{	0L, tirdwr_configure,
	CFG_STATE_LOADED, "tirdwr",
	tirdwr_attributes, 0, NULL},
{	0L, ldtty_configure,
	CFG_STATE_LOADED, "ldtty",
	ldtty_attributes, 0, NULL},
{	0L, xtiso_configure,
	CFG_STATE_LOADED, "xtiso",
	xtiso_attributes, 0, NULL},
{	0L, pts_configure,
	CFG_STATE_LOADED, "pts",
	pts_attributes, 0, NULL},
{	0L, ufs_configure,
	CFG_STATE_LOADED, "ufs",
	ufs_attributes, 0, NULL},
{	0L, vfs_configure,
	CFG_STATE_LOADED, "vfs",
	vfs_attributes, 0, NULL},
{	0L, vm_configure,
	CFG_STATE_LOADED, "vm",
	vm_attributes, 0, NULL},
{	0L, pwrmgr_configure,
	CFG_STATE_LOADED, "pwrmgr",
	pwrmgr_attributes, 0, NULL},
{	0L, kn600_configure,
	CFG_STATE_LOADED, "kn600",
	kn600_attributes, 0, NULL},
{	0L, dc104x_configure,
	CFG_STATE_LOADED, "dc104x",
	dc104x_attributes, 0, NULL},
{	0L, cma_dd_configure,
	CFG_STATE_LOADED, "cma_dd",
	cma_dd_attributes, 0, NULL},
{	0L, cam_disk_configure,
	CFG_STATE_LOADED, "cam_disk",
	cam_disk_attributes, 0, NULL},
{	0L, cam_tape_configure,
	CFG_STATE_LOADED, "cam_tape",
	cam_tape_attributes, 0, NULL},
{	0L, cam_configure,
	CFG_STATE_LOADED, "cam",
	cam_attributes, 0, NULL},
{	0L, isp_configure,
	CFG_STATE_LOADED, "isp",
	isp_attributes, 0, NULL},
{	0L, isa_configure,
	CFG_STATE_LOADED, "isa",
	isa_attributes, 0, NULL},
{	0L, ace_configure,
	CFG_STATE_LOADED, "ace",
	ace_attributes, 0, NULL},
{	0L, pci_configure,
	CFG_STATE_LOADED, "pci",
	pci_attributes, 0, NULL},
{	0L, ws_configure,
	CFG_STATE_LOADED, "ws",
	ws_attributes, 0, NULL},
{	0L, gpc_input_configure,
	CFG_STATE_LOADED, "gpc_input",
	gpc_input_attributes, 0, NULL},
{	0L, vga_configure,
	CFG_STATE_LOADED, "vga",
	vga_attributes, 0, NULL},
{	0L, lsm_configure,
	CFG_STATE_LOADED, "lsm",
	lsm_attributes, 0, NULL},
{	0L, ddr_configure,
	CFG_STATE_LOADED, "ddr",
	ddr_attributes, 0, NULL},
{	0L, kio_configure,
	CFG_STATE_LOADED, "kio",
	kio_attributes, 0, NULL},
{	0L, kds_configure,
	CFG_STATE_LOADED, "kds",
	kds_attributes, 0, NULL},
{	0L, lan_common_configure,
	CFG_STATE_LOADED, "lan_common",
	lan_common_attributes, 0, NULL},
{	0L, per_configure,
	CFG_STATE_LOADED, "per",
	per_attributes, 0, NULL},
{0L, NULL, 0, "  spare entry ", NULL, 0, NULL},
{0L, NULL, 0, "  spare entry ", NULL, 0, NULL},
{0L, NULL, 0, "  spare entry ", NULL, 0, NULL},
{0L, NULL, 0, "  spare entry ", NULL, 0, NULL},
{0L, NULL, 0, "  spare entry ", NULL, 0, NULL},
...
{0L, NULL, 0, "  spare entry ", NULL, 0, NULL},
{0L, NULL, 0, "  spare entry ", NULL, 0, NULL},
{0L, NULL, 0, "", NULL, 0, NULL}
};

char dynamic_subsys_list[] = "envmon ";
