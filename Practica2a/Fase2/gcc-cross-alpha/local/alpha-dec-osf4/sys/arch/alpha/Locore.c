 ...
 * HISTORY
 */
#pragma ident "@(#)$RCSfile: Locore.c,v $ $Revision: 1.1.6.2 $ (DEC) $Date: 1995/11/14 18:39:38 $"
...
int strcmp(char *string1, char *string2) { return 0; }
int strncmp(char *string1, char *string2, int length) { return 0; }
