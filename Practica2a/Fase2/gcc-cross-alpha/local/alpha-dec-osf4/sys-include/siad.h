 ...
 */
/*
 * @(#)$RCSfile: siad.h,v $ $Revision: 1.1.21.8 $ (DEC) $Date: 1995/06/30 08:40:39 $
 */
/***********************************************************************
...
extern  int siad_ses_init __((SIAENTITY *entity, int pkgind));
extern  int siad_ses_authent __((sia_collect_func_t *collect, 
			      SIAENTITY *entityhdl, int siastat,
				int pkgind));
extern  int siad_ses_estab __((sia_collect_func_t *collect, 
			    SIAENTITY *entity, int pkgind));
extern  int siad_ses_launch __((sia_collect_func_t *collect,
			     SIAENTITY *entity,
			     int pkgind));
extern  int siad_ses_suauthent __((sia_collect_func_t *collect,
				SIAENTITY *entity,
				int siastat,
				int pkgind));
extern  int siad_ses_reauthent __((sia_collect_func_t *collect,
				SIAENTITY *entity,
				int siastat,
				int pkgind));
extern  int siad_chg_finger __((sia_collect_func_t *collect,
			       const char *username, int argc, char *argv[]));
extern  int siad_chg_password __((sia_collect_func_t *collect,
			       const char *username, int argc, char *argv[]));
extern  int siad_chg_shell __((sia_collect_func_t *collect,
			       const char *username, int argc, char *argv[]));
extern int siad_getpwent __((struct passwd *result, char *buf, int bufsize, struct sia_context *context));
extern int siad_getpwuid __((uid_t uid, struct passwd *result, char *buf, int bufsize, struct sia_context *context));
extern int siad_getpwnam __((const char *name, struct passwd *result, char *buf, int bufsize, struct sia_context *context));
extern int siad_setpwent __((struct sia_context *context));
extern int siad_endpwent __((struct sia_context *context));
extern int siad_getgrent __((struct group *result, char *buf, int bufsize, struct sia_context *context));
extern int siad_getgrgid __((gid_t gid, struct group *result, char *buf, int bufsize, struct sia_context *context));
extern int siad_getgrnam __((const char *name, struct group *result, char *buf, int bufsize, struct sia_context *context));
extern int siad_setgrent __((struct sia_context *context));
extern int siad_endgrent __((struct sia_context *context));
extern int siad_ses_release __((SIAENTITY *entity, int pkgind));
extern int siad_chk_user __((const char *logname, int checkflag));
extern int siad_get_groups __((struct sia_context *context, const char *username, gid_t *buf, int *numgroups, int maxgroups));
extern void siad_ses_toggle_privs __((SIAENTITY *entity, int pkgind, int elevate));
extern void siad_ses_update_audit_record __((SIAENTITY *entity, int pkgind, int event, char *tokenp, char **datap, int *used, int maxused));

extern int sia_make_entity_pwd __((struct passwd *pwd, SIAENTITY *entity));
extern int sia_setupfp __((int capind, int pkgind, int (*defaultfp)()));
union sia_get_params;	/* forward */
extern int sia_switch __((int capind, union sia_get_params *param, int (*defarray[])()));
extern int sia_audit __((u_int atype, ...));
extern int sia_chdir __((const char *directory, time_t timeout));
extern int sia_timed_action __((int (*action)(void *), void *param, time_t timeout));
extern char *sia_getamsg __((const char *path, int set, int msgnum, const char *defstr));
...
extern void __sia_ses_toggle_privs __((SIAENTITY *entity, int elevate));
extern void __sia_ses_update_audit_record __((SIAENTITY *entity, int event, char *tokenp, char **datap, int *used, int maxused));
...
/* this array is obsolete, and not maintained */
char const *const sia_mechs[] = {	/* must be in same order as NUMs above */
  BSD_SIA,
  DCE,
  X_509,
  OSFC2,
...
/* this array is also obsolete */
int (*const sia_cap_fps[])() = { 0 };
...
extern  sia_handle;
extern	char const *const sia_mechs[]; /* obsolete */
extern	char const *const sia_caps[];
extern	int (*const sia_cap_fps[])(); /* obsolete */
...
extern int __bsd_passwd_lastmatch;
extern int __bsd_group_lastmatch;
