 ...
 * |-----------------------------------------------------------|
 * $ */
/* $Header: /share/buffer/build/rcs.dsk1/os/src/usr/include/alpha/obj.h,v 1.1.18.2 1998/04/28 15:13:45 Randy_Lowell Exp $ */
...
/*
 * Identifiers for miscesllaneous pieces of information.
...
/*
 * Type for miscesllaneous information added with obj_create_addinfo().
 */
typedef union {
    unsigned long	val;
    const void *	ptr;
