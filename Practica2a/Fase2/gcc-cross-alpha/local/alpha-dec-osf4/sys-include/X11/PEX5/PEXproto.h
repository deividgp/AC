 ...
 * HISTORY
 * $Log: PEXproto.h,v $
 * Revision 1.1.2.5  1993/11/23  13:26:56  Jim_Roth
 * 	propagate changes to mainline from ssb
 * 	[1993/11/23  13:25:37  Jim_Roth]
 *
 * Revision 1.1.6.2  1993/10/26  12:41:10  Jim_Roth
 * 	conditionalize path to PEX5 for VMS build only
 * 	[1993/10/26  12:40:22  Jim_Roth]
 * 
 * Revision 1.1.4.2  1993/10/26  12:18:54  Jim_Roth
 * 	conditionalize include path to PEX5 for VMS build
 * 	[1993/10/26  12:18:33  Jim_Roth]
 * 
 * Revision 1.1.2.4  1993/08/12  16:41:28  Jim_Roth
 * 	replace XID with CARD32 in pexQueryTextExtentsReq structure def
 * 	[1993/08/12  16:41:09  Jim_Roth]
 * 
 * Revision 1.1.2.3  1993/04/13  17:49:44  Jim_Roth
 * 	64 bit OSF changes
 * 	[1993/04/13  17:47:04  Jim_Roth]
 * 
 * Revision 1.1.2.2  1993/01/06  12:43:28  Jim_Roth
 * 	"Initial checkin of MIT PEXlib sources"
 * 
 * Revision 1.1.1.2  93/01/06  12:30:47  Jim_Roth
 * 	Initial checkin of MIT PEXlib sources
 * 
 * $EndLog$
 */
...
/* This is the same kludge used in DEC PEXlib PEXproto.h*/
/* Should be undefinded at end of file - jwr */
...
typedef struct {
    ...
    CARD16		    unused B16;
    CARD32		    id B32;	/* was XID - renderer, wks, or text font lut */
