...
#define	XkbNKN_AllChangesMask		(0x7)
...
#define	XkbAXN_AllEventsMask		(0xf)
...
#define	XkbXI_AllFeaturesMask		(0xf)
#define	XkbXI_AllDeviceFeaturesMask	(0x7)
#define	XkbXI_AllDetailsMask		(0x800f)

#define	XkbXI_IndicatorsMask (XkbXI_IndicatorMapsMask|XkbXI_IndicatorNamesMask)
