...
typedef struct _XkbExtensionDeviceNotify {
	...
	unsigned int	names_present;  /* mask of indicators with new names */
	unsigned int	maps_present;	/* mask of indicators with new maps */
...
extern	int	XkbKeyTypesForCoreSymbols(	/* returns # of groups */
    ...
    unsigned	/* protected */,		/* explicit key types */
