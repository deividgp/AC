 ...
 * HISTORY
 * $Log: glxproto.h,v $
 * Revision 1.1.3.2  1997/02/17  21:24:14  devbld_mlo
 * 	More DEC specific changes.  Also, add definitions for old extension
 * 	calls, as we will continue to support these.
 * 	[1997/01/08  17:09:03  Ben_Lipchak]
 *
 * 	This is the new version for OpenGL V1.1
 * 	[1997/01/07  19:28:26  Ben_Lipchak]
 *
 * $EndLog$
 */
/*
 * OLD HISTORY
 * Revision 1.1.2.3  1996/10/01  15:44:36  Tony_Yamamoto
 * 	OpenGL V1.1 port of DEC specific changes
 * 	[1996/10/01  15:42:15  Tony_Yamamoto]
 *
 * Revision 1.1.2.2  1996/06/03  19:45:56  Andy_Vesper
 * 	OpenGL Sample Implementation release 1.1.0
 * 	[1996/06/03  19:38:36  Andy_Vesper]
 * 
 */
...
/* kludge for gl/nt. BOOL is defined by NT in windef.h as typedef int.
 * X defines BOOL as #defind unsigned char, in Xmd.h
 * this define should take care of this for X compilations
 */
#define X_BOOL BOOL

#else	/* NT */
#include "windows.h"	/* PVOID */
#include "wglmd.h"	/* definitions from Xmd.h and glxmd.h
			   needed by glxproto.h for NT,
			   defines X_BOOL as unsigned char
			 */
#endif	/* NT */
#else
#include <GL/glxmd.h>
...
#if defined(DEC) || 1
#define GLX_EXTENSION_ALIAS     "DEC-GLX"
#else
...
*/
#if defined(DEC) && defined(NT)
/* NT passes ptr to rc in place of ctx tag.
 * NT has 32 bit ptrs, so we shouldn't have to worry about
 * screwing up 'size' macros
 */
typedef PVOID  GLXContextTag;
#else
...
/* Add in structure definitions for requests that are missing. */

typedef CARD32 ENUM;

typedef struct GLXDeleteLists {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
typedef struct GLXEndList {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
} xGLXEndListReq;
#define sz_xGLXEndListReq 8

typedef struct GLXFeedbackBuffer {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
typedef struct GLXFinish {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
} xGLXFinishReq;
#define sz_xGLXFinishReq 8

typedef struct GLXFlush {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
} xGLXFlushReq;
#define sz_xGLXFlushReq 8

typedef struct GLXGenLists {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
#define sz_xGLXGenListsReq 12

typedef struct GLXGetBooleanv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
#define sz_xGLXGetBooleanvReq 12

typedef struct GLXGetClipPlane {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
#define sz_xGLXGetClipPlaneReq 12

typedef struct GLXGetDoublev {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
#define sz_xGLXGetDoublevReq 12

typedef struct GLXGetError {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
} xGLXGetErrorReq;
#define sz_xGLXGetErrorReq 8

typedef struct GLXGetFloatv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
#define sz_xGLXGetFloatvReq 12

typedef struct GLXGetIntegerv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
#define sz_xGLXGetIntegervReq 12

typedef struct GLXGetLightfv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
#define sz_xGLXGetLightivReq 16

typedef struct GLXGetMapdv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
#define sz_xGLXGetMapfvReq 16

typedef struct GLXGetMapiv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
#define sz_xGLXGetMapivReq 16

typedef struct GLXGetMaterialfv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
typedef struct GLXGetMaterialiv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
    ENUM	face;
    ENUM	pname;
} xGLXGetMaterialivReq;
#define sz_xGLXGetMaterialivReq 16

typedef struct GLXGetPixelMapfv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
    ENUM	map;
} xGLXGetPixelMapfvReq;
#define sz_xGLXGetPixelMapfvReq 12

typedef struct GLXGetPixelMapuiv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
    ENUM	map;
} xGLXGetPixelMapuivReq;
#define sz_xGLXGetPixelMapuivReq 12

typedef struct GLXGetPixelMapusv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
    ENUM	map;
} xGLXGetPixelMapusvReq;
#define sz_xGLXGetPixelMapusvReq 12

typedef struct GLXGetString {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
#define sz_xGLXGetStringReq 12

typedef struct GLXGetTexEnvfv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
#define sz_xGLXGetTexEnvivReq 16

typedef struct GLXGetTexGendv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
#define sz_xGLXGetTexGenfvReq 16

typedef struct GLXGetTexGeniv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
#define sz_xGLXGetTexGenivReq 16

typedef struct GLXGetTexLevelParameterfv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
typedef struct GLXGetTexLevelParameteriv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
    ...
    INT32	level;
    ENUM	pname;
} xGLXGetTexLevelParameterivReq;
#define sz_xGLXGetTexLevelParameterivReq 20

typedef struct GLXGetTexParameterfv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
typedef struct GLXGetTexParameteriv {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
    ENUM	target;
    ENUM	pname;
} xGLXGetTexParameterivReq;
#define sz_xGLXGetTexParameterivReq 16

typedef struct GLXIsEnabled {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
#define sz_xGLXIsEnabledReq 12

typedef struct GLXIsList {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
#define sz_xGLXIsListReq 12

typedef struct GLXNewList {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
typedef struct GLXSelectBuffer {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
typedef struct GLXGetPolygonStipple {
    CARD8	reqType;
    CARD8	glxCode;
    CARD16	length B16;
    GLXContextTag contextTag B32;
...
/* For support of old extension calls */
#define X_GLrop_BlendColorEXT              4096
#define X_GLrop_BlendEquationEXT           4097
...
#if defined(DEC) || 1
/*
 *  DEC specific request & command definitions
 */
#include <GL/glxdecproto.h>
#endif
