 ...
 * HISTORY
 * $Log: gl.h,v $
 * Revision 1.1.3.3  1997/02/18  15:20:20  devbld_mlo
 * 	{** Merge Information **}
 * 		{** Command used:	bsubmit **}
 * 		{** Ancestor revision:	1.1 **}
 * 		{** Merge revision:	1.1.3.2 **}
 * 	{** End **}
 * 	Retain the polygon extension definitions from the GL_V10 version
 * 	[1997/02/14  16:29:12  Ben_Lipchak]
 *
 * 	Apparently the spec does not specify constant pointers... doh!
 * 	Reverting back to original prototype for glDeleteTextures().
 * 	[1997/01/25  01:26:54  Ben_Lipchak]
 *
 * 	The OpenGL V1.1 spec says that the second argument to
 * 	glDeleteTextures() should not be a constant pointer, contrary
 * 	to the SI sources.  Fixed it.
 * 	[1997/01/25  00:14:34  Ben_Lipchak]
 *
 * 	This is the new version for OpenGL V1.1
 * 	[1997/01/07  19:28:16  Ben_Lipchak]
 *
 * $EndLog$
 */
/*
 * OLD HISTORY from src/xc/include/GL/gl.h
 *
 * Revision 1.1.2.3  1996/10/03  14:58:25  Tony_Yamamoto
 * 	OpenGL V1.1 Port of DEC specific changes
 * 	[1996/10/03  14:57:43  Tony_Yamamoto]
 *
 * Revision 1.1.2.2  1996/06/03  19:45:35  Andy_Vesper
 * 	OpenGL Sample Implementation release 1.1.0
 * 	[1996/06/03  19:37:37  Andy_Vesper]
 * 
 */
#ifndef __gl_h_
#define __gl_h_
...
#if defined(DEC) || 1
/*
 * 32-bit typdefs must be int's not long's
 */
...
/* Extensions */
#if defined(DEC) || 1
#else  /* DEC does not support these now */
...
#ifdef DEC
#define EXT_VERTEX_ARRAY_MAJOR_REVISION   1
#define EXT_VERTEX_ARRAY_MINOR_REVISION   0
#define EXT_VERTEX_ARRAY_NAME	    "GL_EXT_vertex_array"
#define EXT_TEXTURE_OBJECT_MAJOR_REVISION   1
#define EXT_TEXTURE_OBJECT_MINOR_REVISION   0
#define EXT_TEXTURE_OBJECT_NAME	    "GL_EXT_texture_object"
#endif
...
#if defined(DEC) || 1
/*************************************************************
 * EVANS & SUTHERLAND SHADED TEXTURE EXTENSION
 *
 * The following defines support the Evans & Sutherland shaded texture
 * extension.  These parameters can be used with the TexEnv command to
 * determine where the texture color is placed in the texture blend
 * computation.
 *
 * The default behavior is to use GL_FINAL_COLOR_ES which is the
 * normal OpenGL behavior.
 */
#define GL_ES_shaded_texture		1
#define GL_TEXTURE_ENV_COMPONENT_ES	108000
#define GL_FINAL_COLOR_ES		108001
#define GL_DIFFUSE_MATERIAL_COLOR_ES	108002
#endif
...
#else /* GL_EXT_blend_color not supported */

#endif
#if !defined(DEC)
extern void glBlendEquationEXT (GLenum mode);
#else /* GL_EXT_blend_minmax, GL_EXT_blend_logic_op, GL_EXT_blend_subtract not supported */
