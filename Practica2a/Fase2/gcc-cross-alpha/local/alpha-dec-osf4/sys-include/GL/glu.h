 ...
 * HISTORY
 * $Log: glu.h,v $
 * Revision 1.1.3.2  1997/02/17  21:24:25  devbld_mlo
 * 	Add DEC specific change (major and minor version number)
 * 	[1997/01/08  17:16:53  Ben_Lipchak]
 *
 * 	This is the new version for OpenGL V1.1
 * 	[1997/01/07  19:28:18  Ben_Lipchak]
 *
 * $EndLog$
 */
/*
 * OLD HISTORY
 * Revision 1.1.2.2  1996/06/03  19:45:39  Andy_Vesper
 * 	OpenGL Sample Implementation release 1.1.0
 * 	[1996/06/03  19:38:18  Andy_Vesper]
 *
 */
/*
...
#if defined(DEC) || 1
# define GLU_MAJOR_VERSION			1
# define GLU_MINOR_VERSION			2
#endif
