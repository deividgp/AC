...
int main(int np, char *p[])
{
    int i,j,k,neleC;
    double t_total;
    clock_t t_ini;	//Variables que ens serviran per a calcular el temps d'execució
    						//de la part del codi que volem paral·lelitzar. 
    ...
    //Un cop executats els càlculs de multiplicació de la matriu, printarem el temps total
    //total que han requerit per a executar-se.
    t_total = (double)(clock() - t_ini) / CLOCKS_PER_SEC;
    printf("Temps d'execució de la part que voldrem paral·lelitzar: %f", t_total);
